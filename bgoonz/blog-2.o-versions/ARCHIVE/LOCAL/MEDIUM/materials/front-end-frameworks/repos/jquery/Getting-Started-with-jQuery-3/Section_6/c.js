const entries = [
  ...
  },
  {
    ...
    part: "n.",
    definition:
      "The period of human life intermediate between the idiocy of infancy and the folly of youth &mdash; two removes from the sin of manhood and three from the remorse of age.",
  },
  {
    term: "CLARIONET",
    part: "n.",
    definition:
      "An instrument of torture operated by a person with cotton in his ears.  There are two instruments that are worse than a clarionet &mdash; two clarionets.",
  },
  {
    term: "COMFORT",
    part: "n.",
