...
const E_entries = {
  ...
  EDIBLE: {
    part: "adj.",
    definition:
      "Good to eat, and wholesome to digest, as " +
  ...
  ELYSIUM: {
    part: "n.",
    definition:
      "An imaginary delightful country which " +
  ...
  ENVELOPE: {
    part: "n.",
    definition:
      "The coffin of a document; the scabbard " +
...
const F_entries = {
  FAITH: {
    part: "n.",
    definition:
      "Belief without evidence in what is told by one who " +
  ...
  FELON: {
    part: "n.",
    definition:
      "A person of greater enterprise than discretion, who in " +
  ...
  FORGETFULNESS: {
    part: "n.",
    definition:
      "A gift of God bestowed upon doctors in compensation for " +
...
const G_entries = [
  ...
  },
  {
    ...
    part: "n.",
    definition:
      "A person who escapes the evils of moderation by " +
  ...
  },
  {
    ...
    part: "n.",
    definition:
      "Three beautiful goddesses, Aglaia, Thalia and " +
