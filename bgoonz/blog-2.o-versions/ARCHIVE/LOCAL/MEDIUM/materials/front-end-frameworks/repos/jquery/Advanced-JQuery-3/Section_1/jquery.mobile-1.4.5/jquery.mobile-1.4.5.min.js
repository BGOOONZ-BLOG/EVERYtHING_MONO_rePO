            ...
            return (
              ...
              i
                ? ((d.isPath(k) ||
                  ...
                  (c = d.parseUrl(c)),
                  (c =
                    c.protocol + c.doubleSlash + c.host + c.pathname + f + k))
                : (c += c.indexOf("#") > -1 ? l : "#" + l),
              c
            );
          },
    ...
    (function (a, b, c) {
      a.widget("mobile.dialog", {
        ...
        _create: function () {
          var b = this.element,
            c = this.options;
          b.addClass("ui-dialog").wrapInner(
            a("<div/>", {
              role: "dialog",
              class:
                "ui-dialog-contain ui-overlay-shadow" +
        ...
        a.extend(
          {
            ...
            _dragFirstHandle: function (b) {
              return (
                (a.data(this._inputFirst.get(0), "mobile-slider").dragging =
                  !0),
                  ...
                  c
                    ...
                    : a(
                        "<label><input type='checkbox' checked />" +
                          (i.children("abbr").first().attr("title") ||
                            i.text()) +
                          "</label>"
                      )
                        .appendTo(g)
