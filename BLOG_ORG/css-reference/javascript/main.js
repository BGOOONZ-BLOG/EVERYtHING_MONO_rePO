document.addEventListener("DOMContentLoaded", function () {
        ...
        case "Enter":
          if (isSearching && currentMatch > -1) {
            ...
            if ($target) {
              ...
              window.location =
                window.location.origin + "/property/" + propertyName;
            }
          }
          break;
        case "Escape":
  ...
  Array.prototype.forEach.call(
    document.querySelectorAll(".example-value"),
    function ($el) {
  ...
  Array.prototype.forEach.call($launchButtons, function ($launchButton, index) {
    ...
    var $targets = document.querySelectorAll(
      "#" + propertyName + " .example-output-div"
    );
...
function highlightQuery($el, propertyName, query) {
  ...
  if (queryIndex >= 0) {
    ...
    var highlight =
      ...
      propertyName.substring(queryIndex, queryIndex + query.length) +
      "</span>";
