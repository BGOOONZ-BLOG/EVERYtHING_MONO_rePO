/*! For license information please see app-3c57265fe85c14101a0f.js.LICENSE.txt */
  ...
  [5],
  {
    ...
    "+ZDr": function (t, e, n) {
      ...
      e.navigateTo = function (t) {
        return P("navigateTo", "navigate", 3), x(t);
      };
    },
    "/TCF": function (t, e, n) {
      var r = n("REpN"),
    ...
    UxWs: function (t, e, n) {
      ...
      function P(t) {
        var e = w.get(t);
        return (
          e || (e = R.get(t.toLowerCase())),
          null != e && (window.___replace(e.toPath), !0)
        );
      }
      v.forEach(function (t) {
        t.ignoreCase ? R.set(t.fromPath, t) : w.set(t.fromPath, t);
      });
      var O = function (t, e) {
          P(t.pathname) ||
...
//# sourceMappingURL=app-3c57265fe85c14101a0f.js.map
